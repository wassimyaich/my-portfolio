...
const About = () => {
  return (
    <section id="about" className="py-5 mt-5" data-aos="fade-up">
...
With a solid understanding of both front-end and back-end technologies, I'm able to deliver robust and user-friendly solutions. I'm excited to continue learning and growing as a developer, and I'm eager to contribute my skills to innovative projects."
        </p>
      </div>
    </section>
  );
